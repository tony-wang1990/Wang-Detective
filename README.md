...
| CI/测试 | 88% | GitHub Actions 已包含 Java 21、Node 20、前端构建、Maven 构建、脚本换行/语法、前后端接口映射、Telegram 回调映射、乱码/原生弹窗扫描、README 断链检查、排障包脱敏守卫和远程 smoke 覆盖守卫；Windows 本地 acceptance 会自动识别 Git Bash；自动 Release 创建前也会跑发布验证 |
